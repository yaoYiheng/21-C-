...
int main(int argc, char const *argv[])
{
	...
	//Using the l modifier to enter long intergers and doubles.
	puts("Enter an interger and a floating point number.");
	scanf("%ld %lf", &l1, &d1);

	puts("The scanf() format string uesd the l modifier to store");
